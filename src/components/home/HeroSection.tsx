    ...
    >
      ...
      >
        ...
        <div className="overflow-hidden mb-4">
          <motion.h1 className="text-[12vw] sm:text-[10vw] md:text-[12vw] font-display font-semibold leading-none tracking-tighter text-ag-white">
        ...
        >
          <Button
            asChild
            className="bg-ag-copper hover:bg-ag-copper/90 text-ag-white px-8 py-6 text-sm uppercase tracking-widest rounded-none h-auto"
          >
          ...
          <Button
            asChild
            variant="outline"
            className="border-ag-white text-ag-white hover:bg-ag-white hover:text-ag-black px-8 py-6 text-sm uppercase tracking-widest rounded-none h-auto"
          >
